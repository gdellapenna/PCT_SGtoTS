...
//    public CFGrammar apply(CFGrammar g, HashMap<Nonterminal, List<Terminal>> relinside, HashMap<Nonterminal, List<CombinedSymbol>> relfollow) throws GrammarException {
//
//        CFGrammar result = new CFGrammar();
//
//        //Per ogni produzione
//        for (CFProduction prod : (List<CFGProduction>) g.getProductions()) {
//
...
//            CFProduction newprod = new CFProduction(prod.getLHSNonterminal(), prod.getAnchor(), newRHS);
//            int diff = 0;
//
...
//        for (CFProduction prod : (List<CFGProduction>) result.getProductions()) {
//
...
//
//            CFProduction newprod = new CFProduction(S, start);
//            result.addProduction(newprod);
//
//        }
//        //Fine punto 4
