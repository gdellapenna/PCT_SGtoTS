...
public class _RelFollow {
    ...
    public static HashMap<Nonterminal, List<CombinedSymbol>> execute(CFGrammar g) throws GrammarException{
    ...
    private static List<CombinedSymbol> SingleRelFollow(Nonterminal n, CFGrammar g) throws GrammarException{
        ...
        for (CFProduction production : (List<CFProduction>) g.getProductions()){
